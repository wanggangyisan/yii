...
<div class="welcome">
	 <div class="container">
		 <div class="welcome-info">
				<h3>Welcome</h3>
				<h4>这是一个美丽而又充满力量的小世界，希望你能有所获！</h4>
				<p>世界这么大，一样米养百样人，你无法要求所有人的三观都同你吻合，唯一的方法，只有让自己变得更强，心理上的无坚不摧才能保护你，不被那些自私又狭隘的人所伤害。</p>
	     </div>
	 </div>
</div>
<!---->  
			 ...
			 <div class="games-grids">
					 <div class="game-grid-left">
						 <div class="grid1">
							 ...
							 <a href="single.html"><img src="/static/images/c1.jpg" class="img-responsive" alt=""/></a>
						 ...
						 <div class="grid2">
							 ...
							 <a href="single.html"><img src="/static/images/c2.jpg" class="img-responsive" alt=""/></a>
							 <div class="grid1-info">
					 ...
					 <div class="game-grid-right">
						 <div class="grid3">
							 ...
							 <a href="single.html"><img src="/static/images/c3.jpg" class="img-responsive" alt=""/></a>
							 <div class="grid1-info">
						 ...
						 <div class="grid4">
							 ...
							 <a href="single.html"><img src="/static/images/c4.jpg" class="img-responsive" alt=""/></a>
							 <div class="grid1-info">
		  ...
		  <div class="col-md-4 content-right">
              ...
              <div class="tab-content">
						<div role="tabpanel" class="tab-pane active re-pad2" id="home">
						   <div class="game1">
								<div class="col-md-3 tab-pic">
									<a href="single.html"><img src="/static/images/tr1.jpg" alt="/" class="img-responsive"></a>
								</div>
							...
							<div class="game1">
								<div class="col-md-3 tab-pic">
									<a href="single.html"><img src="/static/images/tr3.jpg" alt="/" class="img-responsive"></a>
								</div>
								<div class="col-md-9 tab-pic-info">
							...
							<div class="game1">
								<div class="col-md-3 tab-pic">
									<a href="single.html"><img src="/static/images/tr2.jpg" alt="/" class="img-responsive"></a>
								</div>
								<div class="col-md-9 tab-pic-info">
						...
						<div role="tabpanel" class="tab-pane re-pad2" id="profile">
							<div class="game-post">
								<div class="col-md-3 tab-pic">
									<a href="single.html"><img src="/static/images/tr4.jpg" alt="/" class="img-responsive"></a>
								</div>
							...
							<div class="game-post">
								<div class="col-md-3 tab-pic">
									<a href="single.html"><img src="/static/images/tr5.jpg" alt="/" class="img-responsive"></a>
								</div>
								<div class="col-md-9 tab-post-info">
							...
							<div class="game-post">
								<div class="col-md-3 tab-pic">
									<a href="single.html"><img src="/static/images/tr6.jpg" alt="/" class="img-responsive"></a>
								</div>
								<div class="col-md-9 tab-post-info">
